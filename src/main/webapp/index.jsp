...
<head>
    <meta charset="UTF-8">
    <title>Welcome to Jenkins Window </title>
...
<body>
  <div class="jumbotron" style="background-color:white">
     <h1 class="text-center">Welcome to</h1>
      ...
      <h2 class="text-center">Welcome to all leaders Swathi, Shrirang, Anushuman and Subh on behalf of Infinito Solutions</h2>
